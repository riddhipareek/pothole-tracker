 ...
 *
 * Each section is a plain React component in this file so beginners can
 * see the full page in one place. Buttons use React Router <Link> so they
 * already go to /map and /report — later you can swap those placeholder
 * pages for the real map and report form without changing this file.
 */
